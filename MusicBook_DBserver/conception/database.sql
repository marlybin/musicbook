...
/* Genre des musique. */
CREATE TABLE GenreMusic (id INT  AUTO_INCREMENT PRIMARY KEY, 
	name VARCHAR (40) NOT NULL
);
...
/* Les musiques. */
CREATE TABLE Music(id INT NOT NULL AUTO_INCREMENT PRIMARY KEY ,
	id_User INT , 
	title VARCHAR(40) ,
	artiste VARCHAR(40),
	genre INT,
...
/* Une communauté. */
CREATE TABLE Community ( id INT  AUTO_INCREMENT PRIMARY KEY ,
	id_user INT,
	title VARCHAR(60),
	FOREIGN KEY(id_user) REFERENCES User(id)
);
